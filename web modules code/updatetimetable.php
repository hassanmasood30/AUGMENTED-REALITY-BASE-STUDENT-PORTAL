...
<a href="HOMEPAGE.php">Home</a>
                ...
                <div id="content">
					...
					<div>
						<select class="form-control" name ="aname"  required>
                ...
                ?>
					...
					<div>
						<select class="form-control" id="select_catalog" name="cname" required>
                ...
                ?>
					...
					<div>
                    <select  required class="form-control" id="select_catalog1" onchange=" myFunction()">
                ...
                <div class="form-group" style="width:50%">
					...
					<div>
						<select class="form-control" name ="ename"  required>
                ...
                ?>
                              ...
                              <div class="form-group"  style="width:50%">
					<span class="label-input100">Allot Room No:</span>
					<div>
						<select class="form-control" name ="fname"  required>
							<option value="">Select Room</option>
                 <?php
                         $con = mysqli_connect("localhost","root","","test");
                         $sql = "SELECT DISTINCT room_name from rooms";
			             $result = mysqli_query($con,$sql);	
                        if(mysqli_num_rows($result) > 0)
                         {
                         while ($row = mysqli_fetch_array($result))
                ...
                <div class="form-group"  style="width:50%">
					<span class="label-input100">Slots:</span>
					<div>
                    <select  required class="form-control" id="select_catalog4" onchange=" myFun()">
							<option value="">Select slots</option>
                 <?php
                         $con = mysqli_connect("localhost","root","","test");
                         $sql = "SELECT id,time_Start,time_End from slots";
			             $result = mysqli_query($con,$sql);	
                        if(mysqli_num_rows($result) > 0)
                         {
                         while ($row = mysqli_fetch_array($result))
                         {
                            echo  "<option>" .$row['id']." : ".$row['time_Start']." - ".$row['time_Start']."</option>";
                ...
                <div class="form-group" style="width:50%">
                                ...
                                <input type="text" class="form-control"  placeholder="Slot No" name="gname" id="SID2">
                              </div><br>

                       
                         <button type="submit" class="btn btn-dark">UPDATE TIMETABLE</button>
