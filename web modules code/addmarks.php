...
<a href="HOMEPAGE.php">Home</a>
                ...
                ?>
                  ...
                  <div class="form-group" style="width:50%">
                                ...
                                <input type="number" class="form-control"  placeholder="Course code"  name="dname" id="SID">
                              </div><br>
                              
                              <div class="form-group" style="width:50%">
                                <label >Internal Marks:</label>

                                <input type="number" class="form-control"  placeholder="Enter Marks" name="ename" required>
                              </div><br>
                              <div class="form-group" style="width:50%">
                                <label >External Marks:</label>

                                <input type="number" class="form-control"  placeholder="Enter Marks" name="fname" required>
                              </div><br>
                              <div class="form-group" style="width:50%">
                                <label >Total Marks:</label>

                                <input type="number" class="form-control"  placeholder="Enter Marks" name="gname" required>
                              </div><br>
                              
    
                       
                 <button type="sumit" class="btn btn-dark">ADD MARKS</button>
