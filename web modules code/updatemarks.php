                ...
                ?>
                  ...
                  <div class="form-group" style="width:50%">
                              ...
                              <div class="form-group" style="width:50%">
                                ...
                                <input type="number" class="form-control"  placeholder="Enter Marks" name="ename">
                              </div><br>
                              <div class="form-group" style="width:50%">
                                <label >External Marks:</label>

                                <input type="number" class="form-control"  placeholder="Enter Marks" name="fname">
                              </div><br>
                              <div class="form-group" style="width:50%">
                                <label >Total Marks:</label>

                                <input type="number" class="form-control"  placeholder="Enter Marks" name="gname">
                              </div><br>
                              
    
                       
                 <button type="sumit" class="btn btn-dark">UPDATE MARKS</button>
